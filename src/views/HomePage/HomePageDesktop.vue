      ...
      <div class="hero-content">
        <div class="hero-left">
          ...
          <div class="description-section">
            ...
            <p class="description">
              &nbsp;&nbsp;&nbsp;&nbsp;厦门工学院人工智能创作坊（<strong style="color: #ff6b6b;">AI坊</strong>）是学校根据智能学科发展特点，结合社会实际需求，依托人工智能学院雄厚师资力量而成立的实践创作基地。<strong style="color: #ff6b6b;">AI坊</strong>面向人工智能学院专业学生，构建了一个集<strong style="color: #4ecdc4;">学习</strong>、<strong style="color: #45b7d1;">研发</strong>、<strong style="color: #96ceb4;">展示推广</strong>于一体的创新平台。
            </p>
            <p class="description">
              &nbsp;&nbsp;&nbsp;&nbsp;我们以前沿特色项目实践为导向，着重培养学生的<strong style="color: #f39c12;">AI实践应用能力</strong>与<strong style="color: #9b59b6;">学科综合素养</strong>。同时，<strong style="color: #ff6b6b;">AI坊</strong>也诚挚邀请全校师生将此平台作为教学实践的沃土，共同实现<strong style="color: #27ae60;">教学相长</strong>与<strong style="color: #e67e22;">产学研深度融合</strong>的目标，最终提升学生的<strong style="color: #3498db;">综合实践能力</strong>与<strong style="color: #e74c3c;">创新竞争力</strong>，产出具有实用价值的创新成果。
            </p>
          </div>
          ...
          <div class="action-section">
            ...
            <el-button @click="showEnvironmentPolicy" class="environment-policy-button">
        ...
        <div class="hero-right">
          <div class="features-showcase">
            <div class="feature-card primary" @click="goToDashboard" title="点击查看数据看板">
            ...
            <div class="feature-card secondary" @click="goToAttendanceAnalysis" title="点击查看考勤分析">
              <div class="feature-icon">
            ...
            <div class="feature-card tertiary" @click="goToPointsDashboard" title = "点击查看积分看板">
              <div class="feature-icon">
            ...
            <div class="feature-card quaternary" @click="goToAllMembers" title = "点击查看全部成员">
              <div class="feature-icon">
      ...
      <div class="environment-policy-content">
        <div class="policy-section">
          ...
          <div class="policy-content">
            <p><strong>第一条 目的：</strong>为保障厦门工学院人工智能创作坊（以下简称“创作坊”）拥有整洁、舒适、安全、高效的工作与学习环境，维护设备安全，培养使用者良好习惯，提升空间利用效率，特制定本保障机制。</p>
        ...
        <div class="policy-section">
          ...
          <div class="policy-content">
            ...
            <ol>
              ...
              <li><strong>桌面整洁：</strong>
                <ul>
                  <li><strong>物品精简：</strong>桌面仅限放置与当前工作/学习直接相关的设备（如电脑、开发板）、资料、必要文具及饮用水杯。严禁堆放食物、零食等无关杂物。</li>
                  <li><strong>资料规整：</strong>文件、书籍、笔记本、科研设备等应整齐摆放或及时收纳，避免杂乱无章。</li>
                  <li><strong>桌面整洁：</strong>离开前需清理桌面灰尘、碎屑、水渍、污迹，保持桌面清洁。</li>
                </ul>
              </li>
              <li><strong>垃圾自清：</strong>个人产生的废纸、饮料瓶、零食包装等垃圾，必须自行投入指定垃圾桶内，不得遗留在桌面或地面。垃圾桶内垃圾超过3/4时，应将垃圾打包带走，换上新的垃圾袋。</li>
            </ol>
            ...
            <ol>
              ...
              <li><strong>断电检查：</strong>对于非24小时运行的公共设备（如公用电脑、显示屏、饮水机、部分实验设备），最后离开者或设备使用者有责任确认其已关闭或处于安全待机状态（符合设备要求）。</li>
        ...
        <div class="policy-section">
          ...
          <div class="policy-content">
            ...
            <p><strong>第十二条 处理措施：</strong>对于屡教不改或造成设备损坏、安全隐患的严重违规行为：暂停其使用创作坊权限一定期限。并且通报其所在院系或指导老师。需承担清洁或维修责任。</p>
          </div>
        </div>
        ...
        <div class="policy-section">
          ...
          <div class="policy-content">
            <p><strong>第十三条 温馨提醒：</strong>请爱惜创作坊内所有设施设备。保持环境整洁不仅关乎形象，更能提升专注力、减少干扰、预防事故、延长设备寿命，最终惠及每一位使用者。</p>
