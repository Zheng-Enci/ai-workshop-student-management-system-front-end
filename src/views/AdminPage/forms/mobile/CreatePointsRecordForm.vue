...
<template>
	<el-dialog
		...
		width="90%"
		class="create-points-record-form-dialog"
	...
	>
		...
		<template #footer>
			<div class="create-points-record-form-footer">
...
<style scoped>
/* 移动端适配 */
.create-points-record-form-dialog {
	max-width: 90%;
}

.create-points-record-form-dialog :deep(.el-dialog__body) {
	padding: 15px;
	overflow-x: hidden;
}

.create-points-record-form-dialog :deep(.el-dialog__header) {
	padding: 15px 15px 10px;
}

.create-points-record-form-dialog :deep(.el-dialog__footer) {
	padding: 10px 15px 15px;
}

/* 表单项样式 */
.create-points-record-form-dialog :deep(.el-form-item__label) {
	font-size: 14px;
}

.create-points-record-form-dialog :deep(.el-textarea__inner) {
	font-size: 14px;
}

/* 底部按钮布局 */
.create-points-record-form-footer {
	display: flex;
	gap: 10px;
}

.create-points-record-form-footer .el-button {
	flex: 1;
}

/* 小屏幕适配 */
@media screen and (max-width: 375px) {
	.create-points-record-form-dialog :deep(.el-dialog__title) {
		font-size: 16px;
	}
