...
<template>
	<el-dialog
		...
		width="90%"
		class="update-student-info-form-dialog"
	...
	>
		...
		<template #footer>
			<div class="update-student-info-form-footer">
...
<style scoped>
/* 移动端适配 */
.update-student-info-form-dialog {
	max-width: 90%;
}

.update-student-info-form-dialog :deep(.el-dialog__body) {
	padding: 15px;
	overflow-x: hidden;
}

.update-student-info-form-dialog :deep(.el-dialog__header) {
	padding: 15px 15px 10px;
}

.update-student-info-form-dialog :deep(.el-dialog__footer) {
	padding: 10px 15px 15px;
}

/* 表单项样式 */
.update-student-info-form-dialog :deep(.el-form-item__label) {
	font-size: 14px;
}

.update-student-info-form-dialog :deep(.el-input__inner) {
	font-size: 14px;
}

.update-student-info-form-dialog :deep(.el-select) {
	width: 100%;
}

/* 底部按钮布局 */
.update-student-info-form-footer {
	display: flex;
	gap: 10px;
}

.update-student-info-form-footer .el-button {
	flex: 1;
}

/* 小屏幕适配 */
@media screen and (max-width: 375px) {
	.update-student-info-form-dialog :deep(.el-dialog__title) {
		font-size: 16px;
	}
