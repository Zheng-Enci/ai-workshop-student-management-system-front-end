	...
	<div class="navigation-desktop-header-navigation-container">
		...
		<div class="navigation-desktop-header-main-content">
			...
			<div class="navigation-desktop-user-card-hub-layout">
				...
				<div class="navigation-desktop-nav-sections">
					<!-- 个人中心分组 -->
					<div class="navigation-desktop-nav-section-personal">
						<div class="navigation-desktop-nav-section-personal-header">
							<div class="navigation-desktop-nav-section-personal-title">
								<el-icon class="navigation-desktop-nav-section-personal-icon">
									<user/>
								</el-icon>
								<span>个人中心</span>
							</div>
							<div class="navigation-desktop-nav-section-personal-divider"/>
						</div>

						<div class="navigation-desktop-nav-section-card-grid">
							<div class="navigation-desktop-nav-section-card-card" @click="goToAttendance">
								<div class="navigation-desktop-nav-section-card-card-icon navigation-page-desktop-nav-icon-gradient-1">
									<el-icon size="28">
										<check/>
									</el-icon>
								</div>
								<div class="navigation-desktop-nav-section-card-content">
									<div class="navigation-desktop-nav-section-card-label">签到记录</div>
									<div class="navigation-desktop-nav-section-card-description">查看签到历史记录</div>
								</div>
							</div>

							<div class="navigation-desktop-nav-section-card-card" @click="showProfile">
								<div class="navigation-desktop-nav-section-card-card-icon navigation-page-desktop-nav-icon-gradient-2">
									<el-icon size="28">
										<user/>
									</el-icon>
								</div>
								<div class="navigation-desktop-nav-section-card-content">
									<div class="navigation-desktop-nav-section-card-label">个人信息</div>
									<div class="navigation-desktop-nav-section-card-description">编辑个人资料信息</div>
								</div>
							</div>

							<div class="navigation-desktop-nav-section-card-card" @click="goToScoreChangeRecords">
								<div class="navigation-desktop-nav-section-card-card-icon navigation-page-desktop-nav-icon-gradient-3">
									<el-icon size="28">
										<document/>
									</el-icon>
								</div>
								<div class="navigation-desktop-nav-section-card-content">
									<div class="navigation-desktop-nav-section-card-label">改分记录</div>
									<div class="navigation-desktop-nav-section-card-description">查看所有积分调整记录</div>
								</div>
							</div>

							<div class="navigation-desktop-nav-section-card-card" @click="handleInvitationCode">
								<div class="navigation-desktop-nav-section-card-card-icon navigation-page-desktop-nav-icon-gradient-4">
									<el-icon size="28">
										<star/>
									</el-icon>
								</div>
								<div class="navigation-desktop-nav-section-card-content">
									<div class="navigation-desktop-nav-section-card-label">邀请码</div>
									<div class="navigation-desktop-nav-section-card-description">查看我的邀请码</div>
								</div>
							</div>
						</div>
					</div>
					...
					<!-- 数据查看分组 -->
					<div class="navigation-desktop-nav-section-data">
						<div class="navigation-desktop-nav-section-data-header">
							<div class="navigation-desktop-nav-section-data-title">
								<el-icon class="navigation-desktop-nav-section-data-icon">
									<data-analysis/>
								</el-icon>
								<span>数据查看</span>
							</div>
							<div class="navigation-desktop-nav-section-data-divider"/>
						</div>

						<div class="navigation-desktop-nav-section-card-grid">
							<div class="navigation-desktop-nav-section-card-card" @click="goToAttendanceAnalysis">
								<div class="navigation-desktop-nav-section-card-card-icon navigation-page-desktop-nav-icon-gradient-5">
									<el-icon size="28">
										<data-analysis/>
									</el-icon>
								</div>
								<div class="navigation-desktop-nav-section-card-content">
									<div class="navigation-desktop-nav-section-card-label">考勤分析</div>
									<div class="navigation-desktop-nav-section-card-description">查看考勤数据分析</div>
								</div>
							</div>

							<div class="navigation-desktop-nav-section-card-card" @click="goToDashboard">
								<div class="navigation-desktop-nav-section-card-card-icon navigation-page-desktop-nav-icon-gradient-6">
									<el-icon size="28">
										<data-analysis/>
									</el-icon>
								</div>
								<div class="navigation-desktop-nav-section-card-content">
									<div class="navigation-desktop-nav-section-card-label">数据看板</div>
									<div class="navigation-desktop-nav-section-card-description">查看数据统计图表</div>
								</div>
							</div>

							<div class="navigation-desktop-nav-section-card-card" @click="goToPointsDashboard">
								<div class="navigation-desktop-nav-section-card-card-icon navigation-page-desktop-nav-icon-gradient-7">
									<el-icon size="28">
										<trophy/>
									</el-icon>
								</div>
								<div class="navigation-desktop-nav-section-card-content">
									<div class="navigation-desktop-nav-section-card-label">积分看板</div>
									<div class="navigation-desktop-nav-section-card-description">查看积分排行榜</div>
								</div>
							</div>

							<div class="navigation-desktop-nav-section-card-card" @click="goToAllMembers">
							<div class="navigation-desktop-nav-section-card-card-icon navigation-page-desktop-nav-icon-gradient-8">
								<el-icon size="28">
									<user-filled/>
								</el-icon>
							</div>
							<div class="navigation-desktop-nav-section-card-content">
								<div class="navigation-desktop-nav-section-card-label">查看全部成员</div>
								<div class="navigation-desktop-nav-section-card-description">查看所有成员信息</div>
							</div>
						</div>

						<div class="navigation-desktop-nav-section-card-card" @click="goToIPMonitor">
							<div class="navigation-desktop-nav-section-card-card-icon navigation-page-desktop-nav-icon-gradient-10">
								<el-icon size="28">
									<monitor/>
								</el-icon>
							</div>
							<div class="navigation-desktop-nav-section-card-content">
								<div class="navigation-desktop-nav-section-card-label">IP监控</div>
								<div class="navigation-desktop-nav-section-card-description">查看AI坊IP活跃程度</div>
							</div>
						</div>
					</div>
				</div>
					...
					<!-- 管理功能分组（管理员可见）-->
					<div class="navigation-desktop-nav-section-admin">
						<div class="navigation-desktop-nav-section-admin-header">
							<div class="navigation-desktop-nav-section-admin-title">
								<el-icon class="navigation-desktop-nav-section-admin-icon">
									<user-filled/>
								</el-icon>
								<span>管理功能</span>
							</div>
							<div class="navigation-desktop-nav-section-admin-divider"/>
						</div>

						<div class="navigation-desktop-nav-section-card-grid">
							<div class="navigation-desktop-nav-section-card-card" @click="goToSuperAdmin">
								<div class="navigation-desktop-nav-section-card-card-icon navigation-page-desktop-nav-icon-gradient-9">
									<el-icon size="28">
										<setting/>
									</el-icon>
								</div>
								<div class="navigation-desktop-nav-section-card-content">
									<div class="navigation-desktop-nav-section-card-label">超级管理员</div>
									<div class="navigation-desktop-nav-section-card-description">前往超级管理系统</div>
								</div>
							</div>

							<div class="navigation-desktop-nav-section-card-card" @click="handleAdminClick">
								<div class="navigation-desktop-nav-section-card-card-icon navigation-page-desktop-nav-icon-gradient-10">
									<el-icon size="28">
										<user-filled/>
									</el-icon>
								...
								<div class="navigation-desktop-nav-section-card-content">
									<div class="navigation-desktop-nav-section-card-label">学生管理</div>
									<div class="navigation-desktop-nav-section-card-description">仅供学生管理员使用</div>
								</div>
							</div>
						</div>
					</div>
...
@import '@/views/NavigationPage/css/desktop/navigation-desktop-nav-sections.css';
@import '@/views/NavigationPage/css/desktop/navigation-desktop-nav-section-personal.css';
@import '@/views/NavigationPage/css/desktop/navigation-desktop-nav-section-data.css';
@import '@/views/NavigationPage/css/desktop/navigation-desktop-nav-section-admin.css';
@import '@/views/NavigationPage/css/desktop/navigation-desktop-nav-section-card.css';
</style>
