			...
			<div class="center-hub-layout">
				<div class="center-info-card">
					<div class="center-left-section">
						<div class="center-avatar" @click="handleAvatarClick"
						...
						<div class="center-user-info">
							...
							<div class="center-user-level" :class="getLevelClass(userStore.studentLevel?.levelCode)"
...
const loadPoints = async () => {
	try {
		...
		if (studentIdResponse.code === 200 && studentIdResponse.data) {
			const activityResponse = await getTotalPointsByStudentInfoId(studentIdResponse.data).catch(() => ({
				code: 0,
				data: 0
			}))
...
const loadUserAvatar = async () => {
	try {
		...
		const avatarUrlString = getAvatarUrl(studentInfoId, NavigationPageConfig.AVATAR_SIZE * 2)
