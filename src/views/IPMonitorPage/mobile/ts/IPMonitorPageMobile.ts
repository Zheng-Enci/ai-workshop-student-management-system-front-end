 ...
 * 提供数据初始化、加载和管理功能
 *
 * @module views/IPMonitorPage/mobile/ts/IPMonitorPageDesktop
...
class IPMonitorPageMobile {
	 ...
	 * @static
	 */
	private static instance: IPMonitorPageMobile | null = null
	 ...
	 *
	 * @static
	 * @returns {IPMonitorPageMobile} 单例实例
	 */
	public static getInstance(): IPMonitorPageMobile {
		if (!IPMonitorPageMobile.instance) {
			IPMonitorPageMobile.instance = new IPMonitorPageMobile()
		}
		return IPMonitorPageMobile.instance
	}
...
export default IPMonitorPageMobile
