...
import _PointsApi from '@/api/PointsApi'
...
class AllMembersPageUtils {
	 ...
	 * @param attendanceRankingData - 签到排名数据，格式：[{ studentInfoId: 1, attendanceCount: 50 }, ...]
	 * @param pointsRankingData - 积分排名数据，格式：[{ targetStudentInfoId: 1, totalPoints: 150 }, ...]
	 * @returns 合并后的排序数据，仅包含学生ID，格式：[1, 3, 2, ...]
	 */
