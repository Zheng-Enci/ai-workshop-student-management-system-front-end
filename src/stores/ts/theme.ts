...
export const useThemeStore = defineStore('theme', () => {
	 ...
	 * @type {Ref<boolean>}
	 */
	const autoThemeEnabled: Ref<boolean> = ref(true)
	 ...
	 */
	const checkTimeBasedTheme = (): void => {
		// 如果未启用自动主题，直接返回
	 ...
	 * 设置指定主题
	 *
	 * @param {ThemeType} theme - 主题名称，'dark' 或 'light'
	 */
	 ...
	 * 返回'dark'或'light'字符串
	 *
	 * @type {ComputedRef<ThemeType>}
	 */
	const currentTheme: ComputedRef<ThemeType> = computed(
